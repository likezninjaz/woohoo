				...
				<?php if ( have_posts() ): the_post(); ?>
					<div class="bdaia-template-head">
                        <?php if( ! isset( $bdaia_cat_options['bdaia_cat_rss_icon'] ) ) : ?>
						    <a class="rss-cat-icon rss-icon tooltip-s" title="<?php woohoo_lang_e( 'Feed Subscription' ); ?>" href="<?php $category_id = get_query_var('cat'); echo get_category_feed_link( $category_id ); ?>"><span class="bdaia-io bdaia-io-rss"></span></a>
                        <?php endif; ?>
