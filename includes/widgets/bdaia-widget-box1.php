...
class WOOHOO_WIDGET_BOX1 extends WP_Widget
{
	public $com_meta;
	public $review;
	public $author_meta;
	...
	function __construct()
	{
		...
		parent::__construct (
			'bdaia-widget-box1', '.: Bdaia - Box1',
			array( 'classname' => 'bdaia-box1', 'description' => '' )
		);
	}
	...
	{
		extract( $args );
		$bdaia_att  = $review = $author_meta = $date_meta = "";
		$paged      = 1;
		...
		echo '<div id="'.$args['widget_id'].'" class="widget bdaia-widget bdaia-box1">';
		if ( ! empty( $title ) ) {
			echo '<h4 class="block-title"><span>'. $title .'</span></h4>';
		}
		echo'<div class="widget-inner">'; ?>

		<div class="bdaia-wb-wrap bdaia-wb1 bdaia-wb-id<?php echo $bdaia_rand; ?> bdaia-ajax-pagination-<?php echo $ajax_pagination_class; ?>" <?php echo $bdaia_att;?>>
...
function woohoo_widget__box1() {
	register_widget( 'WOOHOO_WIDGET_BOX1' );
}
add_action( 'widgets_init', 'woohoo_widget__box1' );