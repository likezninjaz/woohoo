...
class WOOHOO_WIDGET_BOX5 extends WP_Widget
{
	public $com_meta;
	public $review;
	public $author_meta;
	...
	function __construct() {
		...
		parent::__construct (
			'bdaia-widget-box5', '.: Bdaia - Box5',
			array( 'classname' => 'bdaia-box5', 'description' => '' )
		);
	}
	...
	public function widget( $args, $instance )
	{
		...
		echo '<div id="'.$args['widget_id'].'" class="widget bdaia-widget bdaia-box5">';
		if ( ! empty( $title ) ) {
			echo '<h4 class="block-title"><span>'. $title .'</span></h4>';
		}
		echo'<div class="widget-inner">'; ?>

		<div class="bdaia-wb-wrap bdaia-wb5 bdaia-wb-id<?php echo $bdaia_rand; ?> bdaia-ajax-pagination-<?php echo $ajax_pagination_class; ?>" <?php echo $bdaia_att;?>>
	...
	public function widget_loop( $thumbnail, $review, $author_meta, $date_meta, $com_meta )
	{
		...
		<div class="bdaia-wb-article bdaia-wba-big bdaiaFadeIn">
			<article class="<?php echo $thum_class; ?>">
				...
				<?php } ?>
				<p class="block-exb"><?php woohoo_ei_slider(); ?></p>
			</article>
		</div>
		<?php
	}
...
function woohoo_widget_box5() {
	register_widget( 'WOOHOO_WIDGET_BOX5' );
}
add_action( 'widgets_init', 'woohoo_widget_box5' );