...
<div class="bdaia-ralated-content bdaia-posts-grid light <?php echo $bd_rel_col_class; ?>" id="content-more-cat">
    <ul class="bdaia-posts-grid-list">
        <?php echo woohoo_related_cat( 0, $category_ids[0], $postID, $numpost ); ?>
    </ul>
    <div class="cfix"></div>
	...
	<script type="text/javascript">
	    ...
	    function woohoo_more_cat() {
	        ...
	        jQuery.ajax({
	            ...
	            type : "POST",
	            data : "action=woohoo_related_cat_fun&page_no="+_bdCatPages+"&cat_id=<?php echo $category_ids[0];?>&post_id=<?php echo $postID ?>&numpost=<?php echo $numpost ?>",
