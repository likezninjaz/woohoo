	...
	<article <?php woohoo_post_class(); ?>>
		<div class="block-article-img-container">
			...
			<?php if ( function_exists("has_post_thumbnail") && has_post_thumbnail() ) : ?>
				<a href="<?php the_permalink(); ?>"><?php the_post_thumbnail( $GLOBALS['thumb_loop6_size'] ); ?></a>
			<?php endif; ?>
		</div>
		<div class="block-article-content-wrapper">
			<header>
				<div class="block-info-cat">
					<?php echo woohoo_custom_primary_category(); ?>
				</div>
            ...
            <footer>
                ...
                <div class="bdaia-post-cat-list"><?php woohoo_lang_e( 'in' ); echo '&nbsp;: &nbsp;'; printf( '%1$s', get_the_category_list( ', ' ) ); ?></div>
			...
			<div class="bd-more-btn"><a href="<?php the_permalink(); ?>"><?php woohoo_lang_e( 'Read More' ); ?><span class="bdaia-io <?php if( is_rtl() ) echo 'bdaia-io-chevron_left'; else echo 'bdaia-io-chevron_right'; ?>"></span></a></div>
		</div>
	</article>
</div>
