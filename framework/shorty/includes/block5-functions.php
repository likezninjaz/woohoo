 ...
 * Block5.
 * ----------------------------------------------------------------------------- */
function woohoo_shorty_block5( $atts, $content = null )
{
	...
	ob_start();
	woohoo_block5( $paged, $block_title, $title_url, $title_text_color, $title_bg_color, $margin_t, $margin_b, $get_term_id, $get_terms_ids, $tag_slug, $num_posts, $offset, $sort_order, $ajax_pagination );
...
$akes( 'bdaia_block5', 'woohoo_shorty_block5' );

function woohoo_block5( $paged, $block_title, $title_url, $title_text_color, $title_bg_color, $margin_t, $margin_b, $cat_uid, $cat_uids, $tag_slug, $num_posts, $offset, $sort_order, $ajax_pagination )
{
	global $post;
	$rndn = woohoo_rand(13);
	...
	$data_attr = array( 'block_nu' => 'b5', 'block_id' => 'bdaia-block-id-'.$rndn, 'paged' => $paged, 'sort_order' => $sort_order , 'ajax_pagination' => $ajax_pagination, 'num_posts' => $num_posts , 'tag_slug' => $tag_slug, 'cat_uid' => $cat_uid, 'cat_uids' => $cat_uids, 'offset' => $offset, 'max_nu' => $mn_pages, 'total_posts_num' => $cat_query->found_posts );
	...
	<div class="bdaia-block-wrap bdaia-block5 bdaia-block-id-<?php echo $rndn;?> bdaia-block-cat-id-<?php echo $cat_uid; ?> bdaia-ajax-pagination-<?php echo $ajax_pagination_class;?>" <?php echo $block_margin; ?> <?php echo $bdaia_att;?>>
