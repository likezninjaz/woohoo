...
function woohoo_mc4wp_form_before_form( $html ) {
	...
	$html .= '<p class="bdaia-mc4wp-bform-p">'.woohoo_lang_tt( 'Get the best viral stories straight into your inbox!', 'woohoo' ).'</p>';
	return $html;
}
...
function woohoo_mc4wp_form_after_form( $html ) {
	$html .= '<p class="bdaia-mc4wp-aform-p">' . woohoo_lang_tt( "Don&rsquo;t worry we don&rsquo;t spam", 'woohoo' ) . '</p>';
	return $html;
}