								...
								<div class="block-article bdaiaFadeIn">
									<article <?php woohoo_post_class(); ?>>
										...
										<div class="block-article-content-wrapper">
											...
											<div class="bd-more-btn"><a href="<?php the_permalink(); ?>"><?php woohoo_lang_t( 'Read More', 'woohoo' ); ?><span class="bdaia-io <?php if( is_rtl() ) echo 'bdaia-io-chevron_left'; else echo 'bdaia-io-chevron_right'; ?>"></span></a></div>
										</div>
