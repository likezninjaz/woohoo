		...
		<div class="block-article block-first-article">
			<article <?php woohoo_post_class(); ?>>
				<div class="block-article-img-container">
					...
					<?php } else { ?>
						<img width="384" height="220" src="<?php echo woohoo_get_video_image( '384x220' ); ?>" alt="" />
					<?php } ?>
				</div>
				<header>
				...
				<footer>
					...
					<?php } else { ?>
						...
						<div class="bdaia-post-author-name">
							<?php woohoo_lang_e( 'By' ); ?>&nbsp;<?php the_author_posts_link(); ?>
				...
				<div class="block-article-content-wrapper">
					<p class="block-exb"><?php echo woohoo_cl( get_the_excerpt() , '200' ) ?></p>
					<?php if( ! $post_reviews ){ ?>
						<div style="display: none !important;" class="bd-more-btn"><a href="<?php the_permalink(); ?>"><?php woohoo_lang_e( 'Read More' ); ?><span class="bdaia-io <?php if( is_rtl() ) echo 'bdaia-io-chevron_left'; else echo 'bdaia-io-chevron_right'; ?>"></span></a></div>
					<?php } ?>
				</div>
			</article>
		</div>
...
<?php } else { ?>
	<?php if( $GLOBALS['bd_bc1'] % 999 == 1 ) echo '<div class="bd-col-md-6 bdaiaFadeIn">'; ?>
	<div class="block-article block-other-article">
		<article <?php woohoo_post_class(); ?>>
			...
			<div class="block-article-content-wrapper">
				<header>
					<h3 class="entry-title"><a href="<?php the_permalink(); ?>"><span><?php the_title(); ?></span></a></h3>
				</header>
				<footer>
					<?php if( $post_reviews ){ ?>
						<div class="bdaia-post-rating">
