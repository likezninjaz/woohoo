<div class="block-article bdaiaFadeIn">
	<article <?php woohoo_post_class(); ?>>
		<header>
			...
			<hr>
			<div class="bdaia-post-date"><?php woohoo_lang_e( 'Posted on' ); echo '&nbsp;&nbsp;'; woohoo_get_time(); ?></div>
			<div class="cfix"></div>
		</header>
		<?php
		...
		<div class="block-article-content-wrapper">
			...
			<div class="post-more-btn"><a href="<?php the_permalink(); ?>"><?php woohoo_lang_e( 'Continue Reading' ); ?></a></div>
		</div>
		<footer>
			...
			<div class="bdaia-post-comment">
				<?php comments_popup_link( woohoo_lang_tt( 'No Comments', 'woohoo' ), woohoo_lang_tt( 'One Comment', 'woohoo' ), '% ' . woohoo_lang_tt( 'Comments', 'woohoo' ) ); ?>
			</div>
			<div class="cfix"></div>
		</footer>
		<div class="cfix"></div>
