...
class WOOHOO_WIDGET_BOX3 extends WP_Widget
{
	public $com_meta;
	public $review;
	public $author_meta;
	...
	function __construct() {
		...
		parent::__construct (
			'bdaia-widget-box3', '.: Bdaia - Box3',
			array( 'classname' => 'bdaia-box3', 'description' => '' )
		);
	}
	...
	public function widget( $args, $instance )
	{
		...
		echo '<div id="'.$args['widget_id'].'" class="widget bdaia-widget bdaia-box3">';
		if ( ! empty( $title ) ) {
			echo '<h4 class="block-title"><span>'. $title .'</span></h4>';
		}
		echo'<div class="widget-inner">'; ?>

		<div class="bdaia-wb-wrap bdaia-wb3 bdaia-wb-id<?php echo $bdaia_rand; ?> bdaia-ajax-pagination-<?php echo $ajax_pagination_class; ?>" <?php echo $bdaia_att;?>>
...
function woohoo_widget_box3() {
	register_widget( 'WOOHOO_WIDGET_BOX3' );
}
add_action( 'widgets_init', 'woohoo_widget_box3' );