...
<?php while ( have_posts() ) : the_post(); ?>
	<div class="bdaia-post-style5-head">
		<div class="bd-container">
			...
			<a class="bdaia-featured-img-cover lightbox-enabled" href="<?php echo woohoo_thumb_src( 'full' ); ?>" <?php if( has_post_thumbnail() ) { ?> style="background-image:url(<?php echo woohoo_thumb_src( $size ); ?>);" <?php } ?>></a>
