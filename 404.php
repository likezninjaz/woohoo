		...
		<div class="bd-container">
			<div class="bd-main--">
				<div class="bdaia-template-head">
					<div class="bdaia-th-container">
						<h4 class="block-title">
							<span>
								<?php woohoo_lang_e( 'Nothing Found' ); ?>
							</span>
						</h4>
						<div class="error-404message"><?php woohoo_lang_e( 'Sorry, the page you were looking for was not found.' ); ?></div>
				...
				<div class="bdaia-block-wrap">
					...
					<h4 class="block-title"><span><?php woohoo_lang_t( 'Check Also', 'woohoo' ); ?></span></h4>
					<div class="bdaia-row">
