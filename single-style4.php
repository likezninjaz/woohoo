	...
	<div class="bd-container bdaia-post-template">
		...
		<div class="bd-main bdaia-site-content" id="bdaia-primary">
			...
			<div id="content" role="main">
				...
				<?php if( $bdaia_p_breadcrumbs ) woohoo_breadcrumbs(); // END Breadcrumbs. ?>
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('hentry'); ?> <?php echo $baia_itemscope; ?>>
						...
						<div class="bdaia-post-content">
							...
							<div class="bdaia-post-featured-left">
								...
								if( ( !empty( $bd_p_featured_image ) && $bd_p_featured_image == false ) || ( empty( $bd_p_featured_image ) && $bdaia_p_featured_image ) ) {
								...
								<?php
								// Post Template Style 4 Ad.
								$bdaia_p_temp_s4_desktop_ad = woohoo_get_option( 'bdaia_p_temp_s4_ad'      ); ?>
								<?php if( $bdaia_p_temp_s4_desktop_ad ) { ?>
									<div class="bdaia-p-temp-s4-e3-desktop"><div class="bdaia-e3-container"><?php echo do_shortcode( stripslashes( $bdaia_p_temp_s4_desktop_ad ) ); ?></div></div>
								<?php } ?>
							</div>
						...
						<footer>
							<?php
							// Tags.
							if ( $bdaia_p_post_tags ) the_tags( '<div class="clear"></div><div class="tagcloud"><span>' . woohoo_lang_tt( 'Tags', 'woohoo' ) . '</span>', '', '</div><div class="clear"></div>' ); ?>
