			...
			<div class="bd-main">
				<?php if ( have_posts() ): the_post(); ?>
					<div class="bdaia-template-head">
						<a class="rss-cat-icon rss-icon tooltip-s" title="<?php woohoo_lang_e( 'Feed Subscription' ); ?>"  href="<?php $tag_id = get_query_var('tag_id'); echo  get_term_feed_link($tag_id , 'post_tag', "rss2") ?>"><span class="bdaia-io bdaia-io-rss"></span></a>
						<div class="bdaia-th-container">
							<?php woohoo_breadcrumbs(); // END Breadcrumbs. ?>
							<h4 class="block-title"><span><?php printf( woohoo_lang_tt( 'Tag Archives:', 'woohoo' ) . ' %s', single_tag_title( '', false ) );	?></span></h4>
							<?php
