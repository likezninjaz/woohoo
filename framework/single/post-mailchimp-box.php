...
if ( woohoo_can_use_plugin( 'mailchimp-for-wp/mailchimp-for-wp.php' ) ) { ?>
	<div class="widget bdaia-widget widget_mc4wp_form_widget">
		<div class="widget-inner">
			...
			<p class="bdaia-mc4wp-bform-p"><?php woohoo_lang_e( 'Want more stuff like this?' ); ?></p>
			<p class="bdaia-mc4wp-bform-p2"><?php woohoo_lang_e( 'Get the best viral stories straight into your inbox!' ); ?></p>
			<?php
