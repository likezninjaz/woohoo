...
class WOOHOO_WIDGET_BOX7 extends WP_Widget
{
	public $com_meta;
	public $review;
	public $author_meta;
	...
	function __construct() {
		...
		parent::__construct (
			'bdaia-widget-box7', '.: Bdaia - Box7',
			array( 'classname' => 'bdaia-box7', 'description' => '' )
		);
	}
	...
	public function widget( $args, $instance )
	{
		...
		echo '<div id="'.$args['widget_id'].'" class="widget bdaia-widget bdaia-box7">';
		if ( ! empty( $title ) ) {
			echo '<h4 class="block-title"><span>'. $title .'</span></h4>';
		}
		echo'<div class="widget-inner">'; ?>

		<div class="bdaia-wb-wrap bdaia-wb7 bdaia-wb-id<?php echo $bdaia_rand; ?> bdaia-ajax-pagination-<?php echo $ajax_pagination_class; ?>" <?php echo $bdaia_att;?>>
			...
			<?php if( $ajax_pagination == 'load_more' ){ ?>
				<div class="bdaia-wb-more-btn" id="bdaia-more-<?php echo $bdaia_rand ?>">
					<div class="bdaia-wb-mb-inner">
						<?php woohoo_lang_e( 'Load more' ); ?><span class="bdaia-io bdaia-io-angle-down"></span>
					</div>
				</div>
			<?php } ?>
			<?php if( $ajax_pagination == 'next_prev' ){ ?>
			...
			<article class="<?php echo $thum_class; ?>">
				<div class="bwb-article-img-container">
					...
					<div class="bwb-article-content-wrapper">
						<header>
                            <div class="block-info-cat" style="display: inline-block;"><?php echo woohoo_custom_primary_category(); ?></div>
...
function woohoo_widget_box7() {
	register_widget( 'WOOHOO_WIDGET_BOX7' );
}
add_action( 'widgets_init', 'woohoo_widget_box7' );