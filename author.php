			...
			<div class="bd-main">
				<?php if ( have_posts() ): the_post(); ?>
					<div class="bdaia-template-head">
						<a class="rss-cat-icon rss-icon tooltip-s" title="<?php woohoo_lang_e( 'Feed Subscription' ); ?>"  href="<?php echo esc_url( get_author_feed_link( get_the_author_meta('ID') ) ); ?>"><span class="bdaia-io bdaia-io-rss"></span></a>
				...
				<div class="bdaia-block-wrap<?php echo $woohoo_block_title; ?>">
					<h4 class="block-title"><span><?php woohoo_lang_e( 'Posts By' ); echo ( ' ' ); the_author(); ?></span></h4>
					<?php
					// Start loop.
					rewind_posts();
