...
if( is_single() ) if( isset( $meta_post_options['sidebar_position_bd'] ) ) $post_sidebars = $meta_post_options['sidebar_position_bd']; // Meta Post Sidebar Postion.
				...
				<?php while ( have_posts() ) : the_post(); ?>
					...
					<article id="post-<?php the_ID(); ?>" <?php post_class('hentry'); ?> <?php echo $baia_itemscope; ?>>
						...
						<div class="bdaia-post-content">
							...
							$bdaia_feautred_image_lightbox  = $bdaia_thumbnail_Object->bdaia_feautred_image_lightbox;
