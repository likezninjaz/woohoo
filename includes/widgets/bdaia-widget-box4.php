...
class WOOHOO_WIDGET_BOX4 extends WP_Widget
{
	public $com_meta;
	public $review;
	public $author_meta;
	...
	function __construct() {
		...
		parent::__construct (
			'bdaia-widget-box4', '.: Bdaia - Box4',
			array( 'classname' => 'bdaia-box4', 'description' => '' )
		);
	}
	...
	public function widget( $args, $instance )
	{
		...
		echo '<div id="'.$args['widget_id'].'" class="widget bdaia-widget bdaia-box4">';
		if ( ! empty( $title ) ) {
			echo '<h4 class="block-title"><span>'. $title .'</span></h4>';
		}
		echo'<div class="widget-inner">'; ?>

		<div class="bdaia-wb-wrap bdaia-wb4 bdaia-wb-id<?php echo $bdaia_rand; ?> bdaia-ajax-pagination-<?php echo $ajax_pagination_class; ?>" <?php echo $bdaia_att;?>>
...
function woohoo_widget_box4() {
	register_widget( 'WOOHOO_WIDGET_BOX4' );
}
add_action( 'widgets_init', 'woohoo_widget_box4' );